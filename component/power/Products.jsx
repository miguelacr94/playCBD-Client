...
const Products = () => {
    ...
    return (
        <div className="mt-6 m-auto md:w-5/6 sm:w-5/6 ">
            <div className="w-contentResponsive sm:w-full sm:text-center md:w-full m-auto ">
                <h2 className="text-black text-lg text-start font-bold md:text-center ">
                    ¡ENCUENTRA EL PRODUCTO QUE NECESITAS!
                </h2>
                <p className="text-black font-bold text-xs mt-18 md:text-center">
