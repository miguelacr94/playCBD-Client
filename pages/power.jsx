        ...
        <div >
            ...
            <main className="w-full mb-20 ">
                <section className="h-screen bg-no-repeat bg-cover bg-home text-white">
                    ...
                    <div className="mt-6 w-contentResponsive sm:w-5/6  md:w-5/6 m-auto flex flex-wrap ">
                      
                        <div className="md:w-3/6 sm:w-3/6 w-full ">
                            <h2 className="text-black text-lg text-start font-bold">A nivel terapéutico</h2>
                            <div className="mt-2.5 md:mt-10 sm:mt-10">
                    ...
                    <div className="mt-cosmetic">
                        <h1 className="sm:mt-20 mt-9 text-black font-medium font-regular text-center text-titlePrimary w-bigLogo md:w-5/6  m-auto leading-9">
